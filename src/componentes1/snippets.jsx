        ...
        <div id="contenedorprincipal" >
            <div id="contenido">
                ...
                <section id="barranav">
                    ...
                    <div id="contenedornav" className="bg-yellow-300 [&>button]:bg-violet-400 flex max-[600px]:flex-col  gap-5 justify-center [&>button]:p-5 p-4 [&>button]:hover:bg-violet-700 [&>button]:hover:-translate-y-4 [&>button]:transition-transform [&>button]:duration-500">
                        <BarraDeNavegacion />
                    </div>
